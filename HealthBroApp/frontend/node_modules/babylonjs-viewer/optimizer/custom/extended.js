 ...
 */
function extendedUpgrade(sceneManager) {
    ...
    if (sceneManager.scene.getEngine().getHardwareScalingLevel() > hardwareScalingLevel) {
        var scaling = math_scalar_1.Scalar.Clamp(sceneManager.scene.getEngine().getHardwareScalingLevel() - 0.25, 0, hardwareScalingLevel);
        sceneManager.scene.getEngine().setHardwareScalingLevel(scaling);
        return false;
    }
...
exports.extendedUpgrade = extendedUpgrade;
/**
...
exports.extendedDegrade = extendedDegrade;
