...
var viewerLabs_1 = require("../labs/viewerLabs");
var custom_1 = require("../optimizer/custom/");
var helper_2 = require("../helper");
var observable_1 = require("babylonjs/Misc/observable");
var sceneOptimizer_1 = require("babylonjs/Misc/sceneOptimizer");
var arcRotateCamera_1 = require("babylonjs/Cameras/arcRotateCamera");
var light_1 = require("babylonjs/Lights/light");
var environmentHelper_1 = require("babylonjs/Helpers/environmentHelper");
var math_1 = require("babylonjs/Maths/math");
var defaultRenderingPipeline_1 = require("babylonjs/PostProcesses/RenderPipeline/Pipelines/defaultRenderingPipeline");
var engine_1 = require("babylonjs/Engines/engine");
var index_1 = require("babylonjs/Animations/index");
var animationPropertiesOverride_1 = require("babylonjs/Animations/animationPropertiesOverride");
var renderTargetTexture_1 = require("babylonjs/Materials/Textures/renderTargetTexture");
var pbrMaterial_1 = require("babylonjs/Materials/PBR/pbrMaterial");
var shadowLight_1 = require("babylonjs/Lights/shadowLight");
var cubeTexture_1 = require("babylonjs/Materials/Textures/cubeTexture");
var math_scalar_1 = require("babylonjs/Maths/math.scalar");
var mesh_1 = require("babylonjs/Meshes/mesh");
var tags_1 = require("babylonjs/Misc/tags");
var scene_1 = require("babylonjs/scene");
var shadowGenerator_1 = require("babylonjs/Lights/Shadows/shadowGenerator");
var SceneManager = /** @class */ (function () {
    function SceneManager(_engine, _configurationContainer, _observablesManager) {
        ...
        this._white = math_1.Color3.White();
        ...
        this.models = [];
        this.onCameraConfiguredObservable = new observable_1.Observable();
        this.onLightsConfiguredObservable = new observable_1.Observable();
        this.onModelsConfiguredObservable = new observable_1.Observable();
        this.onSceneConfiguredObservable = new observable_1.Observable();
        this.onSceneInitObservable = new observable_1.Observable();
        this.onSceneOptimizerConfiguredObservable = new observable_1.Observable();
        this.onEnvironmentConfiguredObservable = new observable_1.Observable();
        this.onVRConfiguredObservable = new observable_1.Observable();
        //this._viewer.onEngineInitObservable.add(() => {
        this._handleHardwareLimitations();
        //});
        this.onSceneInitObservable.add(function (scene) {
            _this.scene.animationPropertiesOverride = _this.scene.animationPropertiesOverride || new animationPropertiesOverride_1.AnimationPropertiesOverride();
            _this.labs = new viewerLabs_1.ViewerLabs(scene);
            var updateShadows = function () {
                for (var _i = 0, _a = _this.scene.lights; _i < _a.length; _i++) {
                    ...
                    if (generator) {
                        ...
                        if (shadowMap) {
                            shadowMap.refreshRate = renderTargetTexture_1.RenderTargetTexture.REFRESHRATE_RENDER_ONCE;
                        }
                    }
                }
            };
    ...
    Object.defineProperty(SceneManager.prototype, "processShadows", {
        ...
        set: function (process) {
            var refreshType = process ? renderTargetTexture_1.RenderTargetTexture.REFRESHRATE_RENDER_ONEVERYFRAME : renderTargetTexture_1.RenderTargetTexture.REFRESHRATE_RENDER_ONCE;
    ...
    SceneManager.prototype.initScene = function (sceneConfiguration, optimizerConfiguration) {
        ...
        if (!sceneConfiguration.defaultMaterial) {
            var defaultMaterial = new pbrMaterial_1.PBRMaterial('defaultMaterial', this.scene);
            defaultMaterial.reflectivityColor = new math_1.Color3(0.1, 0.1, 0.1);
        ...
        this.scene.animationPropertiesOverride = new animationPropertiesOverride_1.AnimationPropertiesOverride();
        index_1.Animation.AllowMatricesInterpolation = true;
    ...
    SceneManager.prototype.updateConfiguration = function (newConfiguration) {
        ...
        if (newConfiguration.lab) {
            ...
            if (this.environmentHelper && newConfiguration.lab.environmentMainColor) {
                var mainColor = new math_1.Color3().copyFrom(newConfiguration.lab.environmentMainColor);
            ...
            if (newConfiguration.lab.globalLightRotation !== undefined) {
                ...
                this.scene.lights.filter(function (light) { return light instanceof shadowLight_1.ShadowLight; }).forEach(function (light) {
    ...
    SceneManager.prototype._rebuildPostprocesses = function (configuration) {
        if (!this._defaultRenderingPipelineEnabled || !configuration_1.getConfigurationKey("scene.imageProcessingConfiguration.isEnabled", this._globalConfiguration)) {
            if (this._defaultRenderingPipeline) {
        ...
        if (pipelineConfig) {
            if (!this._defaultRenderingPipeline) {
                ...
                this._defaultRenderingPipeline = new defaultRenderingPipeline_1.DefaultRenderingPipeline("default rendering pipeline", this._hdrSupport, this.scene, [this.camera], false);
            }
            ...
            if (typeof pipelineConfig !== 'boolean') {
                helper_1.extendClassWithConfig(this._defaultRenderingPipeline, pipelineConfig);
    ...
    SceneManager.prototype._configureScene = function (sceneConfig) {
        ...
        if (sceneConfig.imageProcessingConfiguration) {
            helper_1.extendClassWithConfig(this.scene.imageProcessingConfiguration, sceneConfig.imageProcessingConfiguration);
        }
        //animation properties override
        if (sceneConfig.animationPropertiesOverride) {
            helper_1.extendClassWithConfig(this.scene.animationPropertiesOverride, sceneConfig.animationPropertiesOverride);
        }
        if (sceneConfig.environmentTexture) {
            if (!(this.scene.environmentTexture && this.scene.environmentTexture.url === sceneConfig.environmentTexture)) {
                ...
                var environmentTexture = cubeTexture_1.CubeTexture.CreateFromPrefilteredData(sceneConfig.environmentTexture, this.scene);
    ...
    SceneManager.prototype._configureOptimizer = function (optimizerConfig) {
        ...
        if (typeof optimizerConfig === 'boolean') {
            ...
            if (optimizerConfig) {
                this.sceneOptimizer = new sceneOptimizer_1.SceneOptimizer(this.scene);
                this.sceneOptimizer.start();
            }
        }
        else {
            var optimizerOptions = new sceneOptimizer_1.SceneOptimizerOptions(optimizerConfig.targetFrameRate, optimizerConfig.trackerDuration);
            // check for degradation
            if (optimizerConfig.degradation) {
                switch (optimizerConfig.degradation) {
                    case "low":
                        optimizerOptions = sceneOptimizer_1.SceneOptimizerOptions.LowDegradationAllowed(optimizerConfig.targetFrameRate);
                        break;
                    case "moderate":
                        optimizerOptions = sceneOptimizer_1.SceneOptimizerOptions.ModerateDegradationAllowed(optimizerConfig.targetFrameRate);
                        break;
                    case "hight":
                        optimizerOptions = sceneOptimizer_1.SceneOptimizerOptions.HighDegradationAllowed(optimizerConfig.targetFrameRate);
                        break;
                }
            }
            if (this.sceneOptimizer) {
            ...
            if (optimizerConfig.custom) {
                var customOptimizer_1 = custom_1.getCustomOptimizerByName(optimizerConfig.custom, optimizerConfig.improvementMode);
            ...
            this.sceneOptimizer = new sceneOptimizer_1.SceneOptimizer(this.scene, optimizerOptions, optimizerConfig.autoGeneratePriorities, optimizerConfig.improvementMode);
            this.sceneOptimizer.start();
        }
    ...
    SceneManager.prototype._configureVR = function (vrConfig) {
        ...
        var vrOptions = helper_2.deepmerge({
            ...
            this._vrHelper.onControllerMeshLoadedObservable.add(function (controller) {
                controller.onTriggerStateChangedObservable.add(function (data) {
                    if (controller.mesh && controller.mesh.rotationQuaternion) {
                        if (data.pressed) {
                            if (!rotationOffset_1) {
                                _this.models[0].rootMesh.rotationQuaternion = _this.models[0].rootMesh.rotationQuaternion || new math_1.Quaternion();
    ...
    SceneManager.prototype._configureEnvironmentMap = function (environmentMapConfiguration) {
        if (environmentMapConfiguration.texture) {
            this.scene.environmentTexture = new cubeTexture_1.CubeTexture(this._getAssetUrl(environmentMapConfiguration.texture), this.scene);
        }
        //sanity check
        if (this.scene.environmentTexture) {
            var rotatquatRotationionY = math_1.Quaternion.RotationAxis(math_1.Axis.Y, environmentMapConfiguration.rotationY || 0);
            math_1.Matrix.FromQuaternionToRef(rotatquatRotationionY, this.scene.environmentTexture.getReflectionTextureMatrix());
        }
        // process mainColor changes:
        if (environmentMapConfiguration.mainColor) {
            this._configurationContainer.mainColor = this.mainColor || math_1.Color3.White();
            ...
            var environmentTint = configuration_1.getConfigurationKey("environmentMap.tintLevel", this._globalConfiguration) || 0;
            // reflection color
            ...
            var tmpColor3 = math_1.Color3.Lerp(this._white, this.reflectionColor, environmentTint);
    ...
    SceneManager.prototype._configureCamera = function (cameraConfig) {
        ...
        if (!this.scene.activeCamera) {
            ...
            if (!this.scene.activeCamera) {
                ...
                var arcRotateCamera = new arcRotateCamera_1.ArcRotateCamera("default camera", -(Math.PI / 2), Math.PI / 2, radius, worldCenter, this.scene);
                ...
                var canvas_1 = this.scene.getEngine().getRenderingCanvas();
            }
        ...
        if (cameraConfig.position) {
            ...
            helper_1.extendClassWithConfig(newPosition, cameraConfig.position);
            this.camera.setPosition(newPosition);
        }
        if (cameraConfig.target) {
            var newTarget = this.camera.target.clone();
            helper_1.extendClassWithConfig(newTarget, cameraConfig.target);
            this.camera.setTarget(newTarget);
        } /*else if (this.models.length && !cameraConfig.disableAutoFocus) {
            this._focusOnModel(this.models[0]);
        }*/
        if (cameraConfig.rotation) {
            this.camera.rotationQuaternion = new math_1.Quaternion(cameraConfig.rotation.x || 0, cameraConfig.rotation.y || 0, cameraConfig.rotation.z || 0, cameraConfig.rotation.w || 0);
        }
        ...
        if (this.scene.imageProcessingConfiguration) {
            ...
            this.scene.imageProcessingConfiguration.toneMappingEnabled = !!configuration_1.getConfigurationKey("camera.toneMappingEnabled", this._globalConfiguration);
        }
        ...
        if (!skyboxConifguration && !groundConfiguration) {
            ...
            if (groundConfiguration) {
                ...
                if (groundConfig_1.color) {
                    options.groundColor = new math_1.Color3(groundConfig_1.color.r, groundConfig_1.color.g, groundConfig_1.color.b);
                }
            ...
            if (skyboxConifguration) {
                ...
                if (conf.color) {
                    options.skyboxColor = new math_1.Color3(conf.color.r, conf.color.g, conf.color.b);
                }
            ...
            if (!this.environmentHelper) {
                this.environmentHelper = new environmentHelper_1.EnvironmentHelper(options, this.scene);
            }
            else {
            ...
            if (this.environmentHelper.groundMaterial && groundConfig) {
                ...
                if (this.environmentHelper.groundMirror) {
                    ...
                    this.environmentHelper.groundMirror.clearColor.r = math_scalar_1.Scalar.Clamp(mirrorClearColor.r);
                    this.environmentHelper.groundMirror.clearColor.g = math_scalar_1.Scalar.Clamp(mirrorClearColor.g);
                    this.environmentHelper.groundMirror.clearColor.b = math_scalar_1.Scalar.Clamp(mirrorClearColor.b);
        ...
        if (!lightKeys.length) {
            ...
            lightKeys.forEach(function (name, idx) {
                ...
                if (lightsAvailable_1.indexOf(name) === -1) {
                    var constructor = light_1.Light.GetConstructorFromName(lightConfig.type, lightConfig.name, _this.scene);
                    if (!constructor) {
                        return;
                    }
                    light = constructor();
                ...
                if (light instanceof shadowLight_1.ShadowLight) {
                    // set default values
                    ...
                    if (lightConfig.target) {
                        if (light.setDirectionToTarget) {
                            var target = math_1.Vector3.Zero().copyFrom(lightConfig.target);
                            light.setDirectionToTarget(target);
                        }
                    }
                    else if (lightConfig.direction) {
                        var direction = math_1.Vector3.Zero().copyFrom(lightConfig.direction);
                        light.direction = direction;
                    }
                    var isShadowEnabled = false;
                    if (light.getTypeID() === light_1.Light.LIGHTTYPEID_DIRECTIONALLIGHT) {
                        light.shadowFrustumSize = lightConfig.shadowFrustumSize || 2;
                        isShadowEnabled = true;
                    }
                    else if (light.getTypeID() === light_1.Light.LIGHTTYPEID_SPOTLIGHT) {
                        var spotLight = light;
                    ...
                    else if (light.getTypeID() === light_1.Light.LIGHTTYPEID_POINTLIGHT) {
                        if (lightConfig.shadowFieldOfView) {
                            light.shadowAngle = lightConfig.shadowFieldOfView * Math.PI / 180;
                        }
                        isShadowEnabled = true;
                    }
                    var shadowGenerator_2 = light.getShadowGenerator();
                    if (isShadowEnabled && lightConfig.shadowEnabled && _this._maxShadows) {
                        var bufferSize = lightConfig.shadowBufferSize || 256;
                        if (!shadowGenerator_2) {
                            shadowGenerator_2 = new shadowGenerator_1.ShadowGenerator(bufferSize, light);
                        }
                        var blurKernel = _this.getBlurKernel(light, bufferSize);
                        shadowGenerator_2.bias = _this._shadowGeneratorBias;
                        shadowGenerator_2.blurKernel = blurKernel;
                        //override defaults
                        helper_1.extendClassWithConfig(shadowGenerator_2, lightConfig.shadowConfig || {});
                        // add the focues meshes to the shadow list
                        _this._observablesManager && _this._observablesManager.onModelLoadedObservable.add(function (model) {
                            _this._updateShadowRenderList(shadowGenerator_2, model);
                        });
                        //if (model) {
                        _this._updateShadowRenderList(shadowGenerator_2);
                        //}
                    }
                    else if (shadowGenerator_2) {
                        shadowGenerator_2.dispose();
                    }
                }
            });
            // render priority
    ...
    SceneManager.prototype._updateShadowRenderList = function (shadowGenerator, model, resetList) {
        ...
        for (var index = 0; index < focusMeshes.length; index++) {
            ...
            if (tags_1.Tags.MatchesQuery(mesh, 'castShadow') && shadownMap.renderList.indexOf(mesh) === -1) {
                shadownMap.renderList.push(mesh);
            }
        }
        if (!this._shadowGroundPlane) {
            if (shadowGenerator.useBlurCloseExponentialShadowMap) {
                var shadowGroundPlane = mesh_1.Mesh.CreatePlane("shadowGroundPlane", 100, this.scene, false);
                shadowGroundPlane.useVertexColors = false;
                //material isn't ever used in rendering, just used to set back face culling
                shadowGroundPlane.material = new pbrMaterial_1.PBRMaterial('shadowGroundPlaneMaterial', this.scene);
    ...
    SceneManager.prototype._handleHardwareLimitations = function (enableHDR) {
        ...
        if (linearHalfFloatTargets) {
            this._defaultHighpTextureType = engine_1.Engine.TEXTURETYPE_HALF_FLOAT;
            this._shadowGeneratorBias = 0.002;
        }
        else if (linearFloatTargets) {
            this._defaultHighpTextureType = engine_1.Engine.TEXTURETYPE_FLOAT;
            this._shadowGeneratorBias = 0.001;
        }
        else {
            this._defaultHighpTextureType = engine_1.Engine.TEXTURETYPE_UNSIGNED_INT;
            this._shadowGeneratorBias = 0.001;
        }
        this._defaultPipelineTextureType = this._hdrSupport ? this._defaultHighpTextureType : engine_1.Engine.TEXTURETYPE_UNSIGNED_INT;
    };
    /**
