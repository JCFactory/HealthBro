...
var renderingManager_1 = require("babylonjs/Rendering/renderingManager");
var tools_1 = require("babylonjs/Misc/tools");
var effect_1 = require("babylonjs/Materials/effect");
var configurationCompatibility_1 = require("../configuration/configurationCompatibility");
var configurationContainer_1 = require("../configuration/configurationContainer");
var globals_1 = require("../configuration/globals");
var renderOnlyLoader_1 = require("../configuration/renderOnlyLoader");
var helper_1 = require("../helper/");
var modelLoader_1 = require("../loader/modelLoader");
var observablesManager_1 = require("../managers/observablesManager");
var sceneManager_1 = require("../managers/sceneManager");
var telemetryManager_1 = require("../managers/telemetryManager");
var viewerManager_1 = require("./viewerManager");
/**
...
var AbstractViewer = /** @class */ (function () {
    function AbstractViewer(containerElement, initialConfiguration) {
        ...
        this._configurationContainer = new configurationContainer_1.ConfigurationContainer();
        this.observablesManager = new observablesManager_1.ObservablesManager();
        this.modelLoader = new modelLoader_1.ModelLoader(this.observablesManager, this._configurationContainer);
        renderingManager_1.RenderingManager.AUTOCLEAR = false;
    ...
    AbstractViewer.prototype.getConfigurationLoader = function () {
        return new renderOnlyLoader_1.RenderOnlyConfigurationLoader();
    };
    /**
    ...
    AbstractViewer.prototype._onConfigurationLoaded = function (configuration) {
        var _this = this;
        this._configurationContainer.configuration = helper_1.deepmerge(this.configuration || {}, configuration);
    ...
    AbstractViewer.prototype.takeScreenshot = function (callback, width, height) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                tools_1.Tools.CreateScreenshot(_this.engine, _this.sceneManager.camera, { width: width, height: height }, function (data) {
                    if (callback) {
                        callback(data);
                    }
                    resolve(data);
    ...
    AbstractViewer.prototype.updateConfiguration = function (newConfiguration) {
        ...
        if (typeof newConfiguration === "string") {
            tools_1.Tools.LoadFile(newConfiguration, function (data) {
                try {
            ...
            //backcompat
            configurationCompatibility_1.processConfigurationCompatibility(newConfiguration);
            // update this.configuration with the new data
            this._configurationContainer.configuration = helper_1.deepmerge(this.configuration || {}, newConfiguration);
    ...
    AbstractViewer.prototype._initEngine = function () {
        ...
        if (globals_1.viewerGlobals.disableWebGL2Support) {
            config.engineOptions = config.engineOptions || {};
            config.engineOptions.disableWebGL2Support = true;
        }
        this.engine = new engine_1.Engine(this.canvas, !!config.antialiasing, config.engineOptions);
        ...
        this.sceneManager = new sceneManager_1.SceneManager(this.engine, this._configurationContainer, this.observablesManager);
    ...
    AbstractViewer.prototype.initModel = function (modelConfig, clearScene) {
        ...
        if (this.configuration.model && typeof this.configuration.model === 'object') {
            var globalConfig = helper_1.deepmerge({}, this.configuration.model);
            configuration = helper_1.deepmerge(globalConfig, configuration);
    ...
    AbstractViewer.prototype._initTelemetryEvents = function () {
        var _this = this;
        telemetryManager_1.telemetryManager.broadcast("Engine Capabilities", this.baseId, this.engine.getCaps());
        telemetryManager_1.telemetryManager.broadcast("Platform Details", this.baseId, {
            userAgent: navigator.userAgent,
            platform: navigator.platform
        });
        telemetryManager_1.telemetryManager.flushWebGLErrors(this.engine, this.baseId);
        var trackFPS = function () {
            telemetryManager_1.telemetryManager.broadcast("Current FPS", _this.baseId, { fps: _this.engine.getFps() });
        };
        trackFPS();
    ...
    AbstractViewer.prototype._injectCustomShaders = function () {
        ...
        if (customShaders.shaders) {
            Object.keys(customShaders.shaders).forEach(function (key) {
                ...
                effect_1.Effect.ShadersStore[key] = customShaders.shaders[key];
            });
        }
        if (customShaders.includes) {
            Object.keys(customShaders.includes).forEach(function (key) {
                // typescript considers a callback "unsafe", so... '!'
                effect_1.Effect.IncludesShadersStore[key] = customShaders.includes[key];
            });
        }
    };
