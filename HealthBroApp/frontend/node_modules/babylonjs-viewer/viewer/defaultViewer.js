...
var filesInput_1 = require("babylonjs/Misc/filesInput");
var spotLight_1 = require("babylonjs/Lights/spotLight");
var math_1 = require("babylonjs/Maths/math");
var templateManager_1 = require("../templating/templateManager");
var viewerWithTemplate_1 = require("./viewerWithTemplate");
var standardMaterial_1 = require("babylonjs/Materials/standardMaterial");
var pbrMaterial_1 = require("babylonjs/Materials/PBR/pbrMaterial");
var helper_1 = require("../helper");
var hdButtonPlugin_1 = require("../templating/plugins/hdButtonPlugin");
var printButton_1 = require("../templating/plugins/printButton");
/**
...
var DefaultViewer = /** @class */ (function (_super) {
    ...
    function DefaultViewer(containerElement, initialConfiguration) {
        ...
        _this._updateProgressBar = function () {
            ...
            if (progressSlider && _this._currentAnimation) {
                ...
                if (_this._currentAnimation.state === 1 /* PLAYING */) {
            ...
            _this.sceneManager.setDefaultMaterial = function (sceneConfig) {
                ...
                if ((conf.materialType === 'standard' && this.scene.defaultMaterial.getClassName() !== 'StandardMaterial') ||
                    ...
                    if (conf.materialType === 'standard') {
                        this.scene.defaultMaterial = new standardMaterial_1.StandardMaterial("defaultMaterial", this.scene);
                    }
                    else {
                        this.scene.defaultMaterial = new pbrMaterial_1.PBRMaterial("defaultMaterial", this.scene);
                    }
                }
        ...
        if (this.configuration.templates && this.configuration.templates.viewer) {
            if (this.configuration.templates.viewer.params && this.configuration.templates.viewer.params.enableDragAndDrop) {
                this.onSceneInitObservable.addOnce(function () {
                    var filesInput = new filesInput_1.FilesInput(_this.engine, _this.sceneManager.scene, function () {
                    }, function () {
                    }, function () {
                    }, function () {
                    }, function () {
    ...
    DefaultViewer.prototype._initNavbar = function () {
        ...
        if (navbar) {
            ...
            this.registerTemplatePlugin(new hdButtonPlugin_1.HDButtonPlugin(this));
            this.registerTemplatePlugin(new printButton_1.PrintButtonPlugin(this));
        }
    };
    ...
    DefaultViewer.prototype._onConfigurationLoaded = function (configuration) {
        ...
        this.templateManager = new templateManager_1.TemplateManager(this.containerElement);
    ...
    DefaultViewer.prototype._configureLights = function () {
        ...
        if (this.configuration.lab && this.configuration.lab.flashlight) {
            ...
            var flashlight = new spotLight_1.SpotLight("flashlight", math_1.Vector3.Zero(), math_1.Vector3.Zero(), exponent, angle, this.sceneManager.scene);
            if (typeof this.configuration.lab.flashlight === "object") {
...
}(viewerWithTemplate_1.AbstractViewerWithTemplate));
