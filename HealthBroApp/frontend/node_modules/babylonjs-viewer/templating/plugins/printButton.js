...
var viewerTemplatePlugin_1 = require("../viewerTemplatePlugin");
    ...
    function PrintButtonPlugin(_viewer) {
        ...
        _this._viewer.onModelLoadedObservable.add(function (model) {
            ...
            if (model.configuration.url) {
                var filename = tools_1.Tools.GetFilename(model.configuration.url) || model.configuration.url;
                var baseUrl = model.configuration.root || tools_1.Tools.GetFolderPath(model.configuration.url);
                //gltf, obj, stl
...
}(viewerTemplatePlugin_1.AbstractViewerNavbarButton));
exports.PrintButtonPlugin = PrintButtonPlugin;
