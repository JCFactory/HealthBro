...
var TemplateManager = /** @class */ (function () {
    function TemplateManager(containerElement) {
        ...
        this.templates = {};
        this.onTemplateInit = new observable_1.Observable();
        this.onTemplateLoaded = new observable_1.Observable();
        this.onTemplateStateChange = new observable_1.Observable();
        this.onAllLoaded = new observable_1.Observable();
        this.onEventTriggered = new observable_1.Observable();
    ...
    TemplateManager.prototype.initTemplate = function (templates) {
        ...
        var internalInit = function (dependencyMap, name, parentTemplate) {
            ...
            var addToParent = function () {
                var lastElements = parentTemplate && parentTemplate.parent.querySelectorAll(helper_1.camelToKebab(name));
...
var Template = /** @class */ (function () {
    function Template(name, _configuration) {
        ...
        this.onLoaded = new observable_1.Observable();
        this.onAppended = new observable_1.Observable();
        this.onStateChange = new observable_1.Observable();
        this.onEventTriggered = new observable_1.Observable();
        this.onParamsUpdated = new observable_1.Observable();
        this.onHTMLRendered = new observable_1.Observable();
        this.loadRequests = [];
        this.isLoaded = false;
        this.isShown = false;
    ...
    Template.prototype.updateParams = function (params, append) {
        ...
        if (append) {
            this._configuration.params = helper_2.deepmerge(this._configuration.params, params);
        }
        else {
    ...
    Template.prototype.getChildElements = function () {
        ...
        for (var i = 0; i < children.length; ++i) {
            ...
            if (child) {
                childrenArray.push(helper_1.kebabToCamel(child.nodeName.toLowerCase()));
            }
        }
        ...
        if (!templateConfig) {
            ...
            if (helper_1.isUrl(location_1)) {
                return new Promise(function (resolve, reject) {
                    var fileRequest = tools_1.Tools.LoadFile(location_1, function (data) {
                        resolve(data);
