...
var internalTexture_1 = require("babylonjs/Materials/Textures/internalTexture");
var math_scalar_1 = require("babylonjs/Maths/math.scalar");
var texture_1 = require("babylonjs/Materials/Textures/texture");
/**
...
var TextureUtils = /** @class */ (function () {
    ...
    TextureUtils.GetBabylonCubeTexture = function (scene, textureCube, automaticMipmaps, environment, singleLod) {
        ...
        if (!babylonTexture) {
            ...
            babylonTexture = new cubeTexture_1.CubeTexture('', scene);
            if (environment) {
            ...
            var internalTexture_2 = new internalTexture_1.InternalTexture(scene.getEngine(), internalTexture_1.InternalTexture.DATASOURCE_CUBERAW);
            var glTexture_1 = internalTexture_2._webGLTexture;
            //babylon properties
            internalTexture_2.isCube = true;
            internalTexture_2.generateMipMaps = false;
            babylonTexture._texture = internalTexture_2;
            ...
            var uploadFace = function (i, level, face) {
                ...
                if (i === 0 && level === 0) {
                    internalTexture_2.width = face.width;
                    internalTexture_2.height = face.height;
                }
                    ...
                    if (environment && !scene.getEngine().getCaps().textureLOD && !singleLod) {
                        ...
                        for (var i_1 = 0; i_1 < mipSlices; i_1++) {
                            ...
                            if (lod == null && textureCube.Width) {
                                ...
                                var environmentSpecularLOD = TextureUtils.EnvironmentLODScale * (math_scalar_1.Scalar.Log2(microsurfaceAverageSlopeTexels)) + TextureUtils.EnvironmentLODOffset;
                                ...
                                if (i_1 === 0) {
                                    internalTexture_2._lodTextureLow = lod;
                                }
                                else if (i_1 === 1) {
                                    internalTexture_2._lodTextureMid = lod;
                                }
                                else {
                                    internalTexture_2._lodTextureHigh = lod;
                                }
                                textureCube[lodKey] = lod;
                            }
                        }
                    }
                    internalTexture_2.isReady = true;
                }
    ...
    TextureUtils.ApplySamplingParameters = function (babylonTexture, parameters) {
        ...
        switch (parameters.wrapS) {
            case 10497 /* REPEAT */:
                babylonTexture.wrapU = texture_1.Texture.WRAP_ADDRESSMODE;
                break;
            case 33071 /* CLAMP_TO_EDGE */:
                babylonTexture.wrapU = texture_1.Texture.CLAMP_ADDRESSMODE;
                break;
            case 33648 /* MIRRORED_REPEAT */:
                babylonTexture.wrapU = texture_1.Texture.MIRROR_ADDRESSMODE;
                break;
            default: babylonTexture.wrapU = texture_1.Texture.CLAMP_ADDRESSMODE;
        }
        switch (parameters.wrapT) {
            case 10497 /* REPEAT */:
                babylonTexture.wrapV = texture_1.Texture.WRAP_ADDRESSMODE;
                break;
            case 33071 /* CLAMP_TO_EDGE */:
                babylonTexture.wrapV = texture_1.Texture.CLAMP_ADDRESSMODE;
                break;
            case 33648 /* MIRRORED_REPEAT */:
                babylonTexture.wrapV = texture_1.Texture.MIRROR_ADDRESSMODE;
                break;
            default: babylonTexture.wrapV = texture_1.Texture.CLAMP_ADDRESSMODE;
        }
