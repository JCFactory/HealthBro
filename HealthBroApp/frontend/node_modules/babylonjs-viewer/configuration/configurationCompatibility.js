 ...
 */
function processConfigurationCompatibility(configuration) {
    ...
    if (configuration.scene) {
        ...
        if (configuration.scene.glow) {
            ...
            var enabledProcessing = configuration_1.getConfigurationKey("scene.imageProcessingConfiguration.isEnabled", configuration);
...
exports.processConfigurationCompatibility = processConfigurationCompatibility;
