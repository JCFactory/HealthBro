...
var configurationCompatibility_1 = require("./configurationCompatibility");
var helper_1 = require("../helper");
var tools_1 = require("babylonjs/Misc/tools");
var extended_1 = require("./types/extended");
var renderOnlyDefault_1 = require("./types/renderOnlyDefault");
/**
...
var RenderOnlyConfigurationLoader = /** @class */ (function () {
    ...
    RenderOnlyConfigurationLoader.prototype._getConfigurationTypeExcludeTemplate = function (types) {
        ...
        typesSeparated.forEach(function (type) {
            switch (type.trim()) {
                case 'default':
                    config = helper_1.deepmerge(config, renderOnlyDefault_1.renderOnlyDefaultConfiguration);
                    break;
                case 'none':
                    break;
                case 'extended':
            ...
            if (config.extends) {
                config = helper_1.deepmerge(config, _this._getConfigurationTypeExcludeTemplate(config.extends));
            }
        });
        return config;
    };
    ...
    RenderOnlyConfigurationLoader.prototype.loadConfiguration = function (initConfig, callback) {
        ...
        var loadedConfig = helper_1.deepmerge({}, initConfig);
        ...
        if (loadedConfig.configuration) {
            ...
            return Promise.resolve().then(function () {
                ...
                var mapper = mappers_1.mapperManager.getMapper(mapperType_1);
                var parsed = helper_1.deepmerge(mapper.map(data), loadedConfig);
                var merged = helper_1.deepmerge(extendedConfiguration, parsed);
                configurationCompatibility_1.processConfigurationCompatibility(merged);
                if (callback) {
                    callback(merged);
                }
                return merged;
            ...
            loadedConfig = helper_1.deepmerge(extendedConfiguration, loadedConfig);
            configurationCompatibility_1.processConfigurationCompatibility(loadedConfig);
            if (callback) {
    ...
    RenderOnlyConfigurationLoader.prototype._loadFile = function (url) {
        ...
        return new Promise(function (resolve, reject) {
            var fileRequest = tools_1.Tools.LoadFile(url, function (result) {
...
exports.RenderOnlyConfigurationLoader = RenderOnlyConfigurationLoader;
