...
var GroupModelAnimation = /** @class */ (function () {
    ...
    Object.defineProperty(GroupModelAnimation.prototype, "playMode", {
        ...
        set: function (value) {
            ...
            if (this.state === 1 /* PLAYING */) {
                this._animationGroup.play(this._playMode === 1 /* LOOP */);
            }
            else {
    ...
    GroupModelAnimation.prototype.start = function () {
        this._animationGroup.start(this.playMode === 1 /* LOOP */, this.speedRatio);
...
exports.GroupModelAnimation = GroupModelAnimation;
