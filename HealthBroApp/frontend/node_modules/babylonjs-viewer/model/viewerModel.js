...
var abstractMesh_1 = require("babylonjs/Meshes/abstractMesh");
var observable_1 = require("babylonjs/Misc/observable");
var animationGroup_1 = require("babylonjs/Animations/animationGroup");
...
var multiMaterial_1 = require("babylonjs/Materials/multiMaterial");
var tools_1 = require("babylonjs/Misc/tools");
var modelAnimation_1 = require("./modelAnimation");
...
var ViewerModel = /** @class */ (function () {
    function ViewerModel(_observablesManager, modelConfiguration, _configurationContainer) {
        ...
        this.onLoadedObservable = new observable_1.Observable();
        this.onLoadErrorObservable = new observable_1.Observable();
        this.onLoadProgressObservable = new observable_1.Observable();
        this.onCompleteObservable = new observable_1.Observable();
        this.onAfterConfigure = new observable_1.Observable();
        this.state = ModelState.INIT;
        var scene = this._configurationContainer && this._configurationContainer.scene;
        this.rootMesh = new abstractMesh_1.AbstractMesh("modelRootMesh", scene);
        this._pivotMesh = new abstractMesh_1.AbstractMesh("pivotMesh", scene);
        this._pivotMesh.parent = this.rootMesh;
        // rotate 180, gltf fun
        this._pivotMesh.rotation.y += Math.PI;
        this._scaleTransition = new index_1.Animation("scaleAnimation", "scaling", this._frameRate, index_1.Animation.ANIMATIONTYPE_VECTOR3, index_1.Animation.ANIMATIONLOOPMODE_CONSTANT);
        this._animations = [];
        //create a copy of the configuration to make sure it doesn't change even after it is changed in the viewer
        this._modelConfiguration = helper_1.deepmerge((this._configurationContainer && this._configurationContainer.configuration.model) || {}, modelConfiguration);
    ...
    ViewerModel.prototype.updateConfiguration = function (newConfiguration) {
        this._modelConfiguration = helper_1.deepmerge(this._modelConfiguration, newConfiguration);
        this._configureModel();
    };
    ViewerModel.prototype._initAnimations = function () {
        ...
        if (this.skeletons.length) {
            this.skeletons.forEach(function (skeleton, idx) {
                var ag = new animationGroup_1.AnimationGroup("animation-" + idx, _this._configurationContainer && _this._configurationContainer.scene);
                var add = false;
    ...
    ViewerModel.prototype.setCurrentAnimationByName = function (name) {
        ...
        if (animation) {
            if (this.currentAnimation && this.currentAnimation.state !== 3 /* STOPPED */) {
    ...
    ViewerModel.prototype._configureModel = function () {
        ...
        if (this._modelConfiguration.rotationOffsetAxis) {
            var rotationAxis_1 = new math_1.Vector3(0, 0, 0).copyFrom(this._modelConfiguration.rotationOffsetAxis);
        ...
        if (this._modelConfiguration.castShadow) {
            this._meshes.forEach(function (mesh) {
                tags_1.Tags.AddTagsTo(mesh, 'castShadow');
            });
        }
        var meshes = this._pivotMesh.getChildMeshes(false);
        meshes.filter(function (m) { return m.material; }).forEach(function (mesh) {
    ...
    ViewerModel.prototype._modelAnimationConfigurationToObject = function (animConfig) {
        ...
        if (animConfig.scaling) {
            anim.scaling = math_1.Vector3.Zero();
        }
        ...
        helper_1.extendClassWithConfig(anim, animConfig);
        return anim;
    };
    /**
    ...
    ViewerModel.prototype._applyModelMaterialConfiguration = function (material) {
        ...
        helper_1.extendClassWithConfig(material, this._modelConfiguration.material);
        ...
        else if (material instanceof multiMaterial_1.MultiMaterial) {
    ...
    ViewerModel.prototype._applyAnimation = function (animationConfiguration, isEntry, completeCallback) {
        ...
        if (animationConfiguration.scaling) {
            var scaleStart = isEntry ? animationConfiguration.scaling : new math_1.Vector3(1, 1, 1);
            var scaleEnd = isEntry ? new math_1.Vector3(1, 1, 1) : animationConfiguration.scaling;
    ...
    */
    ...
    ViewerModel.prototype._createEasingFunction = function (easingFunctionID) {
        ...
        switch (easingFunctionID) {
            case 1 /* CircleEase */:
                easingFunction = new index_1.CircleEase();
                break;
            case 2 /* BackEase */:
                easingFunction = new index_1.BackEase(0.3);
                break;
            case 3 /* BounceEase */:
                easingFunction = new index_1.BounceEase();
                break;
            case 4 /* CubicEase */:
                easingFunction = new index_1.CubicEase();
                break;
            case 5 /* ElasticEase */:
                easingFunction = new index_1.ElasticEase();
                break;
            case 6 /* ExponentialEase */:
                easingFunction = new index_1.ExponentialEase();
                break;
            case 7 /* PowerEase */:
                easingFunction = new index_1.PowerEase();
                break;
            case 8 /* QuadraticEase */:
                easingFunction = new index_1.QuadraticEase();
                break;
            case 9 /* QuarticEase */:
                easingFunction = new index_1.QuarticEase();
                break;
            case 10 /* QuinticEase */:
                easingFunction = new index_1.QuinticEase();
                break;
            case 11 /* SineEase */:
                easingFunction = new index_1.SineEase();
                break;
            default:
                tools_1.Tools.Log("No ease function found");
                break;
        }
